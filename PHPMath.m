...
- (void) init: (PHPScriptFunction*) context {
    ...
    [get_digits setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
    ...
    [set_configuration setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
    ...
    [multiply_total setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
    ...
    [subtract_total setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [root_fraction setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [add_total setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [find_continued_fraction setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [assign_continued_fraction setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [result setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [common setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [small_divide setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [root setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [execute_power_whole setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [bit_shift_right setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [bit_shift setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [change_base setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [divide_sub setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [add setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [subtract setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [divide setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [add_fraction setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [mod setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [pow setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    PHPScriptFunction* abs = [[PHPScriptFunction alloc] init];
    [abs setIsAsync:false];
    [abs initArrays];
    [self setDictionaryValue:@"abs" value:abs];
    [abs setPrototype:self];
    [abs setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
        ...
        return @(fabsf([a floatValue]));
    } name:@"main"];
    
    PHPScriptFunction* random_number = [[PHPScriptFunction alloc] init];
    [random_number initArrays];
    [self setDictionaryValue:@"random_number" value:random_number];
    [random_number setPrototype:self];
    [random_number setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        NSObject* input = values[0][0];
        ////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
        NSNumber* min = [self makeIntoNumber:input];
        NSObject* inputmax = values[0][1];
        ////////////NSLog(@"input %@ _ %@", input, values);
        inputmax = [self parseInputVariable:inputmax];
        NSNumber* max = [self makeIntoNumber:inputmax];
        return @([self randomValueBetween:[min intValue] and:[max intValue]]);
    } name:@"main"];
    ...
    [mult setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        ////////NSLog(@"in mult");
        NSObject* input = values[0][0];
        //////////////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    PHPScriptFunction* floor = [[PHPScriptFunction alloc] init];
    [floor initArrays];
    [self setDictionaryValue:@"floor" value:floor];
    [floor setPrototype:self];
    [floor setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        NSObject* input = values[0][0];
        //////////NSLog(@"input: %@", input);
        input = [self parseInputVariable:input];
        //////////NSLog(@"input: %@", input);
    ...
    [round setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        NSObject* input = values[0][0];
        //////////NSLog(@"input: %@", input);
        input = [self parseInputVariable:input];
        //////////NSLog(@"input: %@", input);
    ...
    [round_number setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        NSObject* input = values[0][0];
        //////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];
    ...
    [random_int setClosure:^NSObject *(NSMutableArray *values, PHPScriptFunction* __weak self_instance) {
        NSObject* input = values[0][0];
        //////////////NSLog(@"input %@ _ %@", input, values);
        input = [self parseInputVariable:input];

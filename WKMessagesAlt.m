...
@interface WKMessagesAlt ()


@end

@implementation WKMessagesAlt
- (void) initArrays {
...
-(void)userContentController:(WKUserContentController *)userContentController didReceiveScriptMessage:(WKScriptMessage *)message {
    ...
    //dispatch_barrier_async_and_wait([self queue], ^{
        [[self callback] callCallback:@[message_body]];
    //});
    ...
    //dispatch_sync(concurrent_queue, ^{
        ...
        //[[self webView] websc]*/
        //NSLog(@"message : %@", message_body);
        //NSDictionary* result = [[self interpretation] receiveData:message_body];// function:@"receive_messages"];
        //NSDictionary* result = [[self interpretation] receiveDataDict:message_body function:@"receive_messages"];
        //NSLog(@"result : %@", result);
